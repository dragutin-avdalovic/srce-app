        ...
        <div class="newEntryForm heartForm" @submit.prevent="validateBeforeSubmit">
            ...
            <div class="row">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 form-group min-row-height">
                <label class="control-label" ><p>DIJETE</p>
                  Liječeno na Hematoonkološkom odjelu Pedijatrijske klinike KCUS
                </label>
              </div>
      ...
      <div v-if="step === 4">
        <div class="newEntryForm heartForm" @submit.prevent="validateBeforeSubmit">
          ...
          <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 form-group">
              <button @click.prevent="prev()" class="" type="submit"><p class="save-text">Previous</p></button>
              <button @click.prevent="submit()" class="" type="submit"><p class="save-text">Save</p></button>
            </div>
          </div>
        </div>
      </div>
